...
def main(rows, cols):
    ...
    axs[0].set_title("Relative error eCDF survival functions")
    # axs[0].set(xlim=[0, 0.3], xlabel="relative error")
    axs[0].set(xlim=[0, 0.3], xlabel="relative error")
    axs[2].set_title("Relative error PDFs (estimated with KDE)")
    axs[2].set(xlim=[0, 0.3], xlabel="relative error")
    # axs[2].set(xlim=[0, 0.3], xlabel="relative error")
    axs[1].set_title("Relative error eCDF survival functions")
    # axs[1].set(xlim=[1e-6, 1], xlabel="relative error (log)")
    axs[1].set(xlim=[1e-7, 10], xlabel="relative error (log)")
    axs[1].set_xscale("log")
    axs[3].set_title("Relative error PDFs (estimated with KDE)")
    axs[3].set(xlim=[1e-7, 10], xlabel="relative error (log)")
